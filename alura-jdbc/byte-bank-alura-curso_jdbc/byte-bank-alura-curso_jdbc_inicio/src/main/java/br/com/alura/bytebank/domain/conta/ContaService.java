...
public class ContaService {
    ...
    //private Set<Conta> contas = new HashSet<>(); - todas as funções que utilizavam a lista estatica foram atualizadas

    public Set<Conta> listarContasAbertas() {
        //chamar uma connection conn, pegar a connection do FACTORY e chamar o método
        Connection conn = connection.recuperarConexao();

        //instanciar a classe DAO, passando a conn e chamar o método listar que devolve o Set de contas
